...
def setBridgeAddressFunct(web3,addressFrom:str,_serviceId:int,bridgeAddress:str):
...
def setTechMasterAddressFunct(web3, addressFrom: str, _serviceId: int, _techMasterAddress: str):
    tx_data = generate_tx_data(web3,addressFrom=addressFrom)
...
def addAlertFunct(web3, bridgeAddress: str, _serviceId: int, _alertBody: str):
...
def addMeasureFunct(web3, bridgeAddress: str, _serviceId: int, _measureHeader: str, _measurebody: str):
    tx_data = generate_tx_data(web3,addressFrom=bridgeAddress)
...
if __name__ == "__main__":
    ...
    contract_address = "0x94cbd0d05363c877Ef5C942781f569c9Ba22c515"
    ...
    # tx_hash_addmeasure = addMeasureFunct(web3, bridgeAddress, _serviceId=0, _measureHeader, _measurebody)
