...
if __name__ == "__main__":
    ...
    old_contract_address = web3.toChecksumAddress("0x523cadf901Eab4b5d235a9Ac9932392CEB4780c7")
    contract_address = web3.toChecksumAddress("0x2Cc8051b857158761A04F33b0106679FCa42A8df")
    ...
    contract = web3.eth.contract(address=old_contract_address,abi=abi)
    ...
    tx_hash = web3.eth.sendRawTransaction(signed_tx_bridge.rawTransaction)
